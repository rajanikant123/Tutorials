...
@interface TableViewPagerViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, TableViewPagerViewChanged, ARTableViewPagerDataSource, ARTableViewPagerDelegate> 

@property (strong, nonatomic, readonly) TableViewPagerView *tableViewPagerView;
