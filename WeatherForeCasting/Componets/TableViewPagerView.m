...
#import "TableViewPagerView.h"

@interface TableViewPagerView ()

@property (nonatomic, strong) TableViewPagerPageControl *pageControl;
...
@implementation TableViewPagerView
...
- (void)initializeLayout {
    ...
    self.pageControl = [[TableViewPagerPageControl alloc] initWithFrame:CGRectMake(0, 65, self.bounds.size.width, usedPageControlHeight)];
    ...
    self.scrollView.frame = CGRectMake(self.pageControl.bounds.origin.x, 65+self.pageControl.bounds.origin.y + usedPageControlHeight, self.bounds.size.width, self.bounds.size.height - usedPageControlHeight);
