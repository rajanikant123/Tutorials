...
@interface TableViewPagerViewController ()

@property (nonatomic, strong) NSMutableArray *internalTableViews;
@property (strong, nonatomic) TableViewPagerView *tableViewPagerView;
...
- (void)loadView {
    ...
    TableViewPagerView *pagingTableView = [[TableViewPagerView alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
...
- (void)viewDidLoad {
    ...
    self.tableViewPagerView = (TableViewPagerView *)self.view;
    ...
    [button_Back setFrame:CGRectMake(20, 25, 30, 30)];
    ...
    [ self.tableViewPagerView addSubview:button_Back];
